/**
 * Public surface for `research-trellis-core/mem` — reusable retrieval and
 ...
 * `research-trellis-core` barrel. Import it explicitly:
 *
 *   import { searchMemSessions } from "research-trellis-core/mem";
 *
