/**
 * Public surface for `trellis-hermes-core/mem` — reusable retrieval and
 ...
 * `trellis-hermes-core` barrel. Import it explicitly:
 *
 *   import { searchMemSessions } from "trellis-hermes-core/mem";
 *
