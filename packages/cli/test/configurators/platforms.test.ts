...
const HERMES_BUNDLED_SKILL_NAME = "hermes-research";
...
describe("configurePlatform", () => {
  ...
  it("configurePlatform('gemini') writes TOML commands + SKILL.md skills", async () => {
    ...
    for (const dir of skillDirs) {
      expect(
        dir.name.startsWith("trellis-") || dir.name === HERMES_BUNDLED_SKILL_NAME,
      ).toBe(true);
