...
const SKILL_DESCRIPTIONS: Record<string, string> = {
  ...
  "improve-codebase-architecture":
    "Challenges structural drift before or during refactoring. Use when the task is architecture-sensitive, involves significant restructuring, or needs an explicit guard against unnecessary abstraction and AI-generated spaghetti code.",
  "update-spec":
