 ...
 *
 * Running `research-trellis init` / `research-trellis uninstall` in `$HOME` is catastrophic:
...
/**
 * Error message printed by both `research-trellis init` and `research-trellis uninstall` when
