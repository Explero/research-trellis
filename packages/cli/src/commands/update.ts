...
function collectTemplateFiles(
  ...
  // Hermes research overlay templates.
  for (const [hermesPath, content] of getAllHermesTemplates()) {
    files.set(`${DIR_NAMES.WORKFLOW}/hermes/${hermesPath}`, content);
  }
...
const BACKUP_EXCLUDE_PATTERNS = [
  ...
  // generic worktrees/worktree convention.
  "/trellis-worktrees/",
  "/worktrees/",
  "/worktree/",
];
